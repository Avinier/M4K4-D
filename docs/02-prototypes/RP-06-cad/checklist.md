...
| Whole-robot CoM target | `x = +25 mm`, `h = 124 mm` | Placement target. Layout 02 currently ~+9.7 / ~107.9 mm |
...
CAD already: live Layout 03 import; selected two-wheel / ball / skid; chassis and shell; service panels; removable mobility fascia; Pi 5, battery, power, drivers, C3, IMU envelopes; wiring trunks; mass/CoM overlays; deterministic checks.
...
| P-04 | Whole-robot CoM vs +25 / 124 mm | Layout 02 generated **X ≈ +9.7 mm, Z ≈ 107.9 mm, 2456 g modeled** | Open | Hit the target with battery/ballast placement or revise the baseline. Do not shrink `a_tip` to hide a miss |
| P-05 | Battery low and **forward** of the axle | CAD battery at X = +38 mm | Open | Installed pack geometry from RP-02; HIGH_AFT remains forbidden |
