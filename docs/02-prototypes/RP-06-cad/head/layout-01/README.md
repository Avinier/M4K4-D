...
[Open the head in CAD Viewer](http://127.0.0.1:3245/Users/avinier/robotics/makad/docs/02-prototypes/RP-06-cad?file=head/layout-01/head-layout.step.py)
...
Reference parts in the same viewer workspace: [Camera Module 3 Wide](http://127.0.0.1:3245/Users/avinier/robotics/makad/docs/02-prototypes/RP-06-cad?file=head/layout-01/parts/camera-module-3-wide.step), [XC330](http://127.0.0.1:3245/Users/avinier/robotics/makad/docs/02-prototypes/RP-06-cad?file=head/layout-01/parts/xc330.stp).
