...
- **Neck 60 → 40 mm, spindle replaced by a turntable.** The 24 mm vertical spindle band and the 4 mm bridge are gone. A Ø123 **yaw turntable disc** (3 mm top plate, 8.5 mm skirt rim, bearing hub, Ø14 cable bore) has its top at head Z −30.5 and stands 9.5 mm proud of the body top (head Z −40), leaving a 1 mm running gap. In RP-06 the neutral stack is **140 + 40 + 104 = 284 mm** (was 304).
- **Full motion, guaranteed by the hard stops.** Across the full hard-stop grid (roll ±18, pitch −22…+40) the head sweeps to Z −26.3. The disc top keeps **4.2 mm** at the stops and **2.85 mm** at 1° overtravel. No firmware roll/pitch limit is needed: [`motion-envelope.json`](motion-envelope.json) lists the full range for every row and records both cases.
- **Pi 5 cooler headroom kept.** The disc stands proud so that the RP-06 yaw stage (plate, ring gear, pinion) starts 10.5 mm above the cooler, as in body/chassis Layout 02. The bearing and clock-spring reserve sit above the plate, inside the disc skirt.
- **Short-knee legs.** Each leg rises vertically 12–20 mm behind the pitch axis, clear of the face carrier's chin-down sweep, then angles forward to the trunnion. A gusset spreads each foot on the disc. The external yaw loop no longer needs the long Layout 03 knee because it runs through the disc.
...
- **Body side (RP-06 body/chassis Layout 02):** thin-section bearing, ring gear with skirt to the disc, off-axis pinion and an XC330-size yaw servo on +Y beside the Pi cooler. These are packaging envelopes, not selected parts.
...
- **Still compromised against Layout 03:** the minimum head-to-disc gap is 4 mm, well under the 25 mm finger gap of EN ISO 13854, so there's a pinch zone. The yaw stage is internal, gear-driven and harder to service. The camera sees body geometry from 17.3° of chin-down (Layout 03: 23.6°).
...
- Display remains at Z6…74. Camera PCB starts Z77, giving the requested 3 mm gap. Crown top is **Z104**, +2 mm against Layout 02. The 140 mm body +40 mm neck +104 mm head stack is **284 mm** in the RP-06 integration.
- Neck is **40 mm** from the head underside to the body top; the proud yaw disc takes 9.5 mm of it (see above). Pitch remains an elevated, mass-derived axis; it was not lowered for appearance.
...
The current mass artifact uses **M008=20 g as a nominal E case** and retains **10/20/35 g sensitivity**, producing approximately **366/440/537 g roll/pitch/yaw nominal** (Layout 03: 362/436/509; the disc and less helmet relief add the difference). M008 remains physically `U`. Two 23 g XC330-size servo reference packages are embedded in the nominal tree and must be replaced with each candidate's mass and envelope before actuator selection.
