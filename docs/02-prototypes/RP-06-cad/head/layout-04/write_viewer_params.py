...
manifest=dict(schemaVersion=1,step={'path':'head/layout-04/head-layout.step'},parameters=parameters,features=features)
...
update({params,effects}) {
 ...
 const y={rotate:{axis:[0,0,1],origin:[axes.pitch_x,0,'''+str(m.YAW_INTERFACE_Z)+'''],angleDeg:clamp(params.yaw_deg,-55,55)}};
