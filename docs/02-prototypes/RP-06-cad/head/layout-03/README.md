...
[Interactive CAD Viewer](http://127.0.0.1:3245/Users/avinier/robotics/makad/docs/02-prototypes/RP-06-cad?file=head%2Flayout-03%2Fhead-layout.step.py) · [STEP](head-layout.step) · [construction and feasibility brief](brief.md) · [dimensions](dimensions.md) · [verification](review/verification.md)
