...
- [x] Use the frozen SKU register in [`../RP-03-locomotion/research.md`](../RP-03-locomotion/research.md). A part may
...
- [ ] Re-run forward/rear/side tip, turn, brake, slope and threshold cases from
  [`../RP-03-locomotion/physics.md`](../RP-03-locomotion/physics.md).
