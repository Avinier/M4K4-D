...
- Head transform: Layout 04 head origin `(−pitch_x, 0, 189.5)` in the chassis frame (pitch_x from the head's `axes.json`); the yaw datum is the body top on the yaw axis, `(0, 0, 140)`.
