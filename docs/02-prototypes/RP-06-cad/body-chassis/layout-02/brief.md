...
- Head transform: Layout 04 head origin `(−pitch_x, 0, 180)` in the chassis frame (pitch_x from the head's `axes.json`); the yaw datum is the body top on the yaw axis, `(0, 0, 140)`.
...
- Neck/yoke: no cladding. Head Layout 04's yaw disc stands 9.5 mm proud of the body top over a Ø90 opening. The body carries the thin-section bearing, ring gear, pinion, XC330-size yaw servo and clock-spring reserve, all starting 10.5 mm above the Pi 5 cooler. Full head motion; the hard stops keep the head at least 4 mm off the disc.
...
| Neutral physical height stack | 284 mm (40 mm neck; yaw disc 9.5 mm proud) |
...
- RP-01 Layout 04 yaw legs, turntable and the body-side bearing/gear/pinion/servo are packaging envelopes; bearing and servo SKUs, gear module, load rating, fault-case head/body contact and fabrication detail are not finalized here.
