...
- [x] `wheel_running_clearance_to_static_parts` — {'minimum_mm': 1.5, 'sides': {'L': {'min_gap_mm': 1.5, 'between': ('WHEEL_L_STUB_SHAFT_8MM', 'AXLE_MOTOR_FLANGE_BEARING_BOSS_L')}, 'R': {'min_gap_mm': 1.5, 'between': ('WHEEL_R_STUB_SHAFT_8MM', 'AXLE_MOTOR_FLANGE_BEARING_BOSS_R')}}}
- [x] `drivetrain_static_parts_do_not_interfere` — {'clashes_mm3': {}}
- [x] `motor_face_seats_on_axle_flange` — {'L': {'gap_mm': 0.0, 'overlap_mm3': 0.0}, 'R': {'gap_mm': 0.0, 'overlap_mm3': 0.0}}
- [x] `motor_face_joint_is_engaged` — {'sides': {'L': {'screw_count': 2, 'screw_insertion_mm': [4.0, 4.0], 'thread_engaged_in_faceplate_mm': [2.85, 2.85], 'hole_depth_mm': 6.0, 'shaft_engaged_in_stub_mm': 8.5, 'shaft_stub_overlap_mm3': 0, 'screw_head_to_inner_bearing_mm': 0.5}, 'R': {'screw_count': 2, 'screw_insertion_mm': [4.0, 4.0], 'thread_engaged_in_faceplate_mm': [2.85, 2.85], 'hole_depth_mm': 6.0, 'shaft_engaged_in_stub_mm': 8.5, 'shaft_stub_overlap_mm3': 0, 'screw_head_to_inner_bearing_mm': 0.5}}, 'rule': 'M3 thread in the tapped faceplate >= 2.5 mm, insertion <= hole depth - 0.5; shaft >= 8 mm in the stub; heads >= 0.4 mm off the bearing'}
- [x] `bearings_sit_inside_flange_boss` — {'bearings': {'BEARING_608ZZ_L_1': True, 'BEARING_608ZZ_L_2': True, 'BEARING_608ZZ_R_1': True, 'BEARING_608ZZ_R_2': True}, 'boss_end_y_mm': 88.0}
...
- [x] `selected_audio_and_imu_parts_are_clear` — {'clashes_mm3': {}, 'self_clashes_mm3': {}, 'harness_volume_overlaps_OPEN_mm3': {'SPEAKER_ACOUSTIC_CAVITY_KEEP_OUT x HARNESS_SIGNAL_TRUNK': 23.0, 'SPEAKER_ACOUSTIC_CAVITY_KEEP_OUT x HARNESS_SENSOR_TRUNK': 23.0}, 'parts': 26}
- [x] `speaker_is_k50wp_outline_behind_front_panel` — {'depth_mm': 18.0, 'diameter_mm': 50.0, 'frame_face_x_mm': 97.5, 'front_panel_inner_face_x_mm': 98.0, 'vendor': 'Visaton K 50 WP 8 ohm: Ø50 x 18 mm, Ø46 cutout, 48 g'}
- [x] `mic_packages_on_port_axes_against_boots` — {'FRONT_L': {'package_off_axis_mm': 0.0, 'board_outer_abs_y_mm': 70.0}, 'FRONT_R': {'package_off_axis_mm': 0.0, 'board_outer_abs_y_mm': 70.0}, 'REAR_L': {'package_off_axis_mm': 0.0, 'board_outer_abs_y_mm': 70.0}, 'REAR_R': {'package_off_axis_mm': 0.0, 'board_outer_abs_y_mm': 70.0}}
- [x] `imu_board_seated_on_deck_with_both_screws_in_material` — {'board_bottom_z_mm': 56.0, 'deck_top_z_mm': 56.0, 'shank_in_deck_mm3': {'IMU_M2_SCREW_SHANK_L': 12.566, 'IMU_M2_SCREW_SHANK_R': 12.566}, 'board_vs_deck_mm3': 0, 'board_x_mm': [13.0, 29.0]}
...
- [ ] `rear_tail_clears_shell_and_panels` — {'shell_overlap_mm3': 0, 'panel_overlap_mm3': 220.21846899762676}
...
- [x] `power_boards_are_in_the_electronics_group` — {'children': ['PCB02_CHARGE_AND_SYSTEM_POWER', 'PCB03_MOTOR_GATE_AND_HEAD_RAIL', 'PCB04_BRANCH_CONVERTERS', 'PACK_ATOF_FUSE_HOLDER_ENVELOPE', 'ESTOP_XA1E_BV3U02KT_R'], 'proposal': 'RP-02 board-specs.md sec 2, 2026-09-25'}
- [x] `power_boards_clear_of_all_real_hardware` — {'clashes_mm3': {}, 'checked_against': 152, 'keep_outs_included': True}
- [x] `power_boards_do_not_interfere_with_each_other` — {'clashes_mm3': {}}
- [x] `power_boards_keep_running_gaps` — {'minimum_mm': 0.4, 'nearest': {'PCB02_CHARGE_AND_SYSTEM_POWER_PCB': {'nearest_mm': 0.8, 'to': 'REAR_PANEL_ESTOP_WELL'}, 'PCB02_CHARGE_AND_SYSTEM_POWER_PARTS_ENVELOPE': {'nearest_mm': 2.0, 'to': 'CHASSIS_DECK_WITH_BODY_INTERFACE'}, 'PCB03_MOTOR_GATE_AND_HEAD_RAIL_PCB': {'nearest_mm': 1.0, 'to': 'BODY_LOWER_CROSS_FRONT'}, 'PCB03_MOTOR_GATE_AND_HEAD_RAIL_PARTS_ENVELOPE': {'nearest_mm': 1.0, 'to': 'BODY_LOWER_CROSS_FRONT'}, 'PCB04_BRANCH_CONVERTERS_PCB': {'nearest_mm': 0.5, 'to': 'MOTOR_L_PIGTAIL_RESERVE'}, 'PCB04_BRANCH_CONVERTERS_PARTS_ENVELOPE': {'nearest_mm': 0.9, 'to': 'C3_ESP32_S3_DEVKITC_STEP'}, 'PACK_ATOF_FUSE_HOLDER_ENVELOPE': {'nearest_mm': 1.3, 'to': 'CHASSIS_RAIL_L_FRONT'}, 'ESTOP_XA1E_MUSHROOM_D29': {'nearest_mm': 4.519, 'to': 'REAR_PANEL_ESTOP_AMBER_BEZEL'}, 'ESTOP_XA1E_OPERATOR_COLLAR': {'nearest_mm': 6.5, 'to': 'REAR_PANEL_INTERNAL_FRAME_WITH_BOSSES'}, 'ESTOP_XA1E_UNIBODY_CONTACT_BLOCK': {'nearest_mm': 8.006, 'to': 'REAR_PANEL_INTERNAL_FRAME_WITH_BOSSES'}, 'ESTOP_XA1E_TAB_1': {'nearest_mm': 6.181, 'to': 'C0_RASPBERRY_PI5_EXACT_STEP'}, 'ESTOP_XA1E_TAB_2': {'nearest_mm': 6.938, 'to': 'C0_RASPBERRY_PI5_EXACT_STEP'}, 'ESTOP_XA1E_TAB_3': {'nearest_mm': 12.799, 'to': 'C0_RASPBERRY_PI5_EXACT_STEP'}}}
...
- [x] `power_boards_clear_of_harness_power_routes` — {'overlaps_mm3': {}, 'note': 'HARNESS_BATTERY_TRUNK (Y +18, Z 57.5-62.5) and HARNESS_MOTOR_BRANCH (X 30-42, Z 56.5-62.5) run in the 7 mm slot under PCB-03/04 (Z 56-63) and clear the IMU; still route-volume placeholders, not a wire-by-wire harness'}
...
- [x] `estop_operator_is_outside_the_rear_panel_and_keep_out_clears_the_pi` — {'head_min_x_mm': -73.0, 'head_max_x_mm': -63.5, 'panel_outer_face_x_mm': -60.4, 'keep_out_x_mm': [-50.4, -26.5], 'keep_out_z_mm': [94.5, 116.5], 'head_z_mm': [91.0, 120.0], 'rear_panel_top_z_mm': 134.0, 'head_vs_panel_mm3': 0, 'head_proud_of_panel_mm': 12.6, 'well_vs_frame_mm3': 0, 'well_gap_to_frame_mm': 0.268, 'keep_out_vs_pcb02_mm3': 0, 'rear_panel_cut_out': 'octagonal well with a Ø16.2 floor cut-out (IDEC XA)'}
- [x] `pcb01_replaces_generic_bms_at_2p9mm` — {'pcb01_size_mm': [20.0, 48.0, 2.9], 'previous_bms_mm': [20.0, 48.0, 4.5]}
- [x] `control_power_sensors_row_replaced_by_board_rows` — {'replaced_rows_g': 121.5, 'removed_row_g': 121.5, 'estop_g': 14.0, 'battery_g': 113.7, 'total_mass_g': 2529.4, 'note': 'hand-kept register: masses are RP-02 estimates, not derived from the solids'}
...
- [x] `com_inside_support_x` — {'com_x_mm': 19.379155045241752}
- [x] `com_forward_of_physics_margin_line` — {'com_x_mm': 19.38, 'com_h_mm': 106.96, 'x_over_h': 0.1812, 'a_tip_m_s2': 1.777, 'a_tip_min_m_s2': 1.582, 'equivalent_min_x_mm_at_this_h': 17.25, 'margin_over_a_peak_1p00': 1.777, 'baseline_target': {'x_mm': 25.0, 'h_mm': 124.0, 'x_over_h': 0.202}, 'body_shift_x_mm': 16.0, 'rule': 'RP-03 physics.md 2.5 margin is a_tip = g*x/h against a_peak 0.80-1.00 m/s2. The +20 mm line is that margin evaluated at h = 124 mm (a_tip 1.582); it is re-based 2026-09-25 (builder acceptance BA-06, decision RP03-CAD-09) to the same a_tip because the register CoM height is now about 105 mm. Neutral head only; head-pose corners are in RP03-CAD-09'}
- [x] `ball_share_above_spin_walk_flag` — {'ball_share': 0.1762, 'flag_below': 0.09}
- [x] `rear_skid_catches_before_com_crosses_axle` — {'shoe_first_contact_pitch_deg': 6.054, 'com_over_axle_pitch_deg': 10.27}
- [x] `com_below_head_yaw` — {'com_z_mm': 106.95828828707945}
