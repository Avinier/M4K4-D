...
- Total modeled mass: 2567.8 g
- Whole-robot CoM: X=18.77, Y=1.00, Z=105.05 mm
- Static ball share (x/L): 0.171 of weight; RP-03 physics.md §3.6 flags < 0.09 as a spin-walk risk
- Forward-launch ball lift (a_tip = g·x/h): 1.75 m/s² vs compiled a_max ≤ 0.80 m/s²

| Item | Mass (g) | CoM (mm) | Source |
|---|---:|---|---|
| `RP01_HEAD_LAYOUT04` | 555.19 | (15.27, 0.67, 222.62) | RP-01 generated mass tree |
