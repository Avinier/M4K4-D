...
def main():
    dims = {
        ...
        "overall_height_status": f"{M.OVERALL_PHYSICAL_HEIGHT:.0f} mm neutral stack (Layout 04 head, 40 mm neck to the body top; was 304 mm)",
        "head_motion_envelope": "RP-01 Layout 04 motion-envelope.json: full roll ±18 / pitch −22…+40; hard stops alone keep ≥4 mm to the yaw disc (≥2 mm at 1° overtravel)",
