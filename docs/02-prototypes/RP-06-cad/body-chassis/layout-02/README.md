...
- **Wheel left / right** in degrees, + forward, ±2 turns. With *Wheels drive the robot on the floor* on (default), the robot moves as a differential drive: equal angles roll it straight, opposed angles spin it on the axle midpoint, one wheel alone pivots about the other's contact.
