...
| Motor-arm, source-selector, E-stop switching devices | IDEC E-stop operator (the screened lead `PCD-EST-01` is the XW1E; the CAD carries the smaller XA1E-BV3U02KT-R since 2026-09-25) and LTC4368-1/external-FET approach are screened leads, not a selected safety subsystem | Fault-current, FET SOA, regeneration and interruption calc | `power-component-candidate-screen.md` §6; `power-architecture.md` PA-13/14 | G01 demonstration |
| Smaller rear E-stop (appearance) | The builder wants the rear E-stop about 50–60% of its current size. Kept for now: IDEC `XA1E-BV3U02KT-R` (Ø29 mushroom, 12.6 mm proud, 23.9 mm deep) in the octagonal well with the amber bezel. No certified E-stop (EN 60947-5-5) was found below Ø25. Option A, still certified: NKK `FF0126BACEEA01` (FF01, Ø25 cap, 2NC/DPST, TÜV EN 60947-5-5, 20.6 mm above the panel, 13.6 mm deep); its shallow body lets the well sink further, for about 7–8 mm proud and a ~35 mm bezel (~70–75% of the current look). Option B, a true 50–60% copy: a generic 12–16 mm latching mushroom, which is **not** an E-stop device (CE only, no direct-opening contacts or safety latch, usually 1NO+1NC); acceptable only with a certified E-stop elsewhere, such as a wireless remote. Also open: `PCD-EST-01` still names the XW1E | Builder choice between A, B and the current XA; if A, NKK drawing check and India sourcing | `RP-06-cad/body-chassis/layout-02/README.md` (rear E-stop redesign); `RP-02-electrical/board-specs.md` §2; `power-component-candidate-screen.md` §6 | Rear panel appearance freeze; `PCD-EST-01` supersession |
