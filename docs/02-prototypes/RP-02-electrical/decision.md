...
| Created | 2026-09-08 |
| Revised | 2026-09-24 (battery working selection; not a registered baseline) |
...
| Battery chemistry — **WORKING SELECTION 2026-09-24 (builder direction; not registered under an `RP02-P*-REG`)** | **Li-ion NMC cylindrical, 18650**, as a retained protected pack module. Constraints set by the builder: price and fit in the CAD tub. LiFePO4 rejected (2S is 6.4 V nominal and sags toward 5 V under load, about 40% less energy density, too big for the tub); LiPo pouch rejected (fragile, swells, not needed at these currents); 21700 rejected on fit (about 27 mm high against a 24 mm tub). Ledger sizing and cell/BMS candidates are in `power-calculation-ledger.md` §5.3 and `power-component-candidate-screen.md` §9.2 | Placement low and forward; complete assembly must satisfy `PB-MAIN`; handling rules in `workbench.md` (pack fabrication stays deferred to the battery gate) | Measured pack impedance vs state of charge and temperature; BMS thresholds; G06 charging/removal paths; solo-builder risk. **No purchase authorized** |
| Pack configuration — **2S CLOSED as the working baseline 2026-09-24 (builder direction)** | **2S1P: two Samsung INR18650-25R cells + 2S 20 A balanced BMS** (about 18 Wh nominal, 6.0–8.4 V, 110 g `E`, 37.6 × 67 × 23.8 mm). 3S remains admissible only if RP-01 picks a 12 V servo class, and would reopen the pack, BMS and charge settings | Coupled to RP-01 servo family (PA-04). C01 points at 5 V class → 2S + motor-domain buck. RP-06 CAD carries the pack as `RP03-CAD-07` | RP-01 actuator selection (reopens if 12 V class); measured `CC-PEAK-01` sag against the 6.0 V low line |
