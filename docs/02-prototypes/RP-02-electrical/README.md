...
| Field | Value |
|---|---|
| Status | **Parts 1–4 are complete at design-definition level.** Part 4 is `RP02-P4-REG-01` (C0↔C2, 2026-09-17) plus `RP02-P4-REG-02` (C0↔C3 `BASE_*` **semantics**, 2026-09-18). Byte layouts, numeric timeouts, remaining component suffixes, purchase and scored evidence stay open. Phase A is live |
...
| [Link contract](link-contract.md) | Registered Part-4 C0↔C2 definition (`RP02-P4-REG-01`) and C0↔C3 `BASE_*` **semantics** (`RP02-P4-REG-02`). Byte layouts, type numbers, baud and measured timeouts remain open on both links | A |
