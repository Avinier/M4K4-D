// RP-03 Layout 02 review controls. Geometry dimensions remain Python-owned.
...
export default {
  manifest: {
    schemaVersion: 1,
    step: {
      path: "docs/02-prototypes/RP-03-locomotion/cad/body-chassis/layout-02/body-chassis.step"
    },
    parameters: {
      head_yaw_deg: {
        type: "number",
