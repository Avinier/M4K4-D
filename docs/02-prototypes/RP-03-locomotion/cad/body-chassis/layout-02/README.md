...
- front and rear shell openings now repeat the trapezoidal service-panel profiles with a continuous 2 mm overlap, internal frames, bosses and four M3 screws per panel;
...
docs/02-prototypes/RP-03-locomotion/cad/base/pass-01/.venv/bin/python \
  ...
  docs/02-prototypes/RP-03-locomotion/cad/body-chassis/layout-02/body-chassis.step.py \
  --write
```
