...
|---|---|---|---|
| Representative head load and envelope | Complete head 100 H × 180 W × 130 D mm; ~250 g target; preliminary `J≈0.001 kg·m²` | G02–G06 | registered as-built/CAD mass, CoM, inertia proxy, axis offsets, ballast revision, and clearance proxy; preliminary `~0.2 N·m` is not itself a gate |
| Gimbal-centre sensitivity | Concept A A0/A1/A2 axis-to-CoM points from `physics.md` | G02–G05 | gravity/hold torque over full travel, busy-minute RMS/current/temperature, unpowered direction, yoke/ear clearance and revised CoM after mechanism mass is added |
...
| Fast sharp yaw | `HM-07` no, exactly 2 cycles/1.00 s or 2 cycles/0.95 s; stitched `MJ5` reversals | G02, G03 | launch, every reversal and settle; peak acceleration/current, reversal loss, ringing and final settle |
| Small correction | `HM-05` tracking, authored 4° / 2–4° | G03, G04 | smallest repeatable move; complete-output dial-indicator test at `±0.50·τ_peak,op`, candidate maximum lost motion ≤0.50° / ≤0.25°; chatter and camera disturbance |
...
| Pitch micro-pulse | `HM-08` laugh, 2 pulses/0.80 s or 3 pulses in 0.68 s active window; `MJ5` pulse train | G03 | 7°/100 ms local reversal, candidate output lost-motion budget, unintended vibration/noise |
...
| Harness restoring load | Complete candidate head harness through yaw/pitch/roll workspace | G03–G05 | angle-dependent restoring torque, slow-motion distortion, connector motion, bend/strain relief, endurance and unpowered pull; route must approach each joint near its axis |
...
| Unpowered/fault rest | `HM-00` plus power/controller/feedback fault cases | G01, G04 | passive motion, support, hard-stop/cable behavior and restart policy |
