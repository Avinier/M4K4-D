...
- RP-01 moving-head planning tree: nominal **~358/432/557 g roll/pitch/yaw** at M008=20 g E (Layout 04), with **~547–572 g complete** across M008=10–35 g. The C2 module is selected but its installed mass remains `U`; the tree also contains two 23 g XC330-size reference packages that must be replaced per servo candidate. The former 250 g target is historical only;
