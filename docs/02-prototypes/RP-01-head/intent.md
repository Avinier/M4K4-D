...
- three-axis neck allocation: **49.5 mm vertical** ([Layout 04](../RP-06-cad/head/layout-04/README.md), 2026-09-23; was 60 mm), of which ~34.5 mm is visible above the 15 mm proud yaw turntable disc;
- RP-01 moving-head planning tree: nominal **~370/464/588 g roll/pitch/yaw** at M008=20 g E (Layout 04), with **~578–603 g complete** across M008=10–35 g. The C2 module is selected but its installed mass remains `U`; the tree also contains two 23 g XC330-size reference packages that must be replaced per servo candidate. The former 250 g target is historical only;
