...
| M007 | Status LED/PCB + optic/diffuser + mount + wiring assigned here | 1 | M007 | `U` |  |  |  |  |  |  | Yes | Article selected 2026-09-26: WS2812B-2020 on a 5 × 5 mm carrier + Ø3.4 × 2.9 light pipe + 3 × AWG30 (`HEAD-CAD-12`); weigh when built, 5 g `E` allowance stands |
