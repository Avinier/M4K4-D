...
1. create `run.md` in the run directory from the blank form below;
...
Replace every required placeholder. Do not use `same as before`, `latest`, or `unknown` for a scored run.
