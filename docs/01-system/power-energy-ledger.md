...
| Governed by | `risk-prototype-plan.md` v1.10 §"Continuous sourcing and data workstream" (power/energy/thermal ledger deliverable) and §RP-02 (G02 invariant, G03 rehearsal) |
...
| S03 attentive idle | SBC avg + camera + display + small servo motion | 7–14 | 6 min | 0.70–1.40 |
...
| **`MD-01` total** | | **average ≈ 8–15 W** | **≈ 20 min** | **≈ 2.5–4.7 Wh** |
...
- Required pack energy at the top of the range with 25 % reserve and 80 % usable depth of discharge: `4.7 / 0.8 × 1.25 ≈ 7.3 Wh`. A 2S1P of ordinary 2.5 Ah 18650s is ≈ 18 Wh; a 2S 1500 mAh LiPo is ≈ 11 Wh. **Neither is a selection**; the point is that the trip-wire in §6 is not close to firing on the planning envelope, and the interesting risk is the *peak*, not the energy.
