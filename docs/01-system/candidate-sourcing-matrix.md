...
|---|---|---|---|---|---|---:|---:|---|---|---|
| Main compute (SBC) — **suggested lead candidate, not selected** | **Raspberry Pi 5, 2 GB** (2026-09-14 review suggestion): same BCM2712/ISP/libcamera path as larger variants; the locked IMX708 camera has no usable stack outside Raspberry Pi, so the SBC choice is effectively Pi-bound. Needs a 22-to-15-pin CSI cable, the official active cooler and a 5 V / 5 A compute buck. Pi 5 1 GB not suggested (memory edge); Pi 4 4 GB now costs more than a Pi 5 2 GB for ~⅓ the compute | Hubtronics ₹8,260 incl. GST, 5 in stock; ElectroPi ₹7,399 + GST ≈ ₹8,731, 34 in stock (both 2026-09-14). For reference: Pi 5 4 GB ₹14,499 (0 stock), Pi 5 8 GB ₹20,349 (3), Pi 4 4 GB ≈ ₹12,150 | In stock | 0–3 d | Pi 5 4 GB if memory proves tight (≈ +₹6k); Pi 5 1 GB only under recorded evidence | 1 | **≈ 8,300–9,500 board + cooler + CSI cable** (was 4,000–9,000) | Med — Raspberry Pi raised prices twice in 2026 on LPDDR4 cost; 2 GB tier untouched by the April round so far. Reconfirm before payment | — | Case/mount printed; vent path and fan-noise separation from body mics |
